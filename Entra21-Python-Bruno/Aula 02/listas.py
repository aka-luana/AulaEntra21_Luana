...
print(*lista) # o * imprime todos os itens da lista
...
fruta = lista.pop(2) # quando não passa parâmetro ele remove o ultimo
...
# item de uma lista
print(lista[-1]) # -1 começa de tras para frente
# de x até y (sem y)
print(lista[0:2])
